<template>
    <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            ...
            <div>
                <router-link to="/login" class="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4">
                    Login
                </router-link>
                <router-link to="/signup" class="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4">
                    Register
                </router-link>
